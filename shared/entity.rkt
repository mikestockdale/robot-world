...
(provide (struct-out entity) make-edge
         entity-symbol entity-at-location
...
(define (entity-at-location source new-location)
  (struct-copy entity source [location new-location]))

(define (entity-symbol entity laden?)
...
(module+ test
  ...
  (test-case
   ...
   (check-equal?
    (entity-at-location (entity 101 type-bot (location 1 2)) (location 3 4))
